    ...
    <div className="relative mt-5">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center w-full">
        ...
        <div className="flex gap-5 justify-center mt-2">
          <button className="btn btn-success text-sm md:text-xl">
            Explore Now
          </button>
          <button class="btn bg-transparent text-white hover:bg-white hover:text-black border-white text-sm md:text-xl">
            Our Feedback
          </button>
        </div>
      </div>
